...
OUTPUT_DIR="figures_resnet50_tinyimagenet"
DISPLAY_NAMES="Base SDN Cascading ZTW"
...
# head diversity matrix
#RUN_NAMES="..."
#DISPLAY_NAMES="SDN Cascading ZTW"
#REFERENCE_RUN="..."
#singularity exec $SINGULARITY_ARGS $SIF_PATH python -m visualize.head_diversity --run_names $RUN_NAMES --reference_run_name $REFERENCE_RUN --display_names $DISPLAY_NAMES --use_wandb
#singularity exec $SINGULARITY_ARGS $SIF_PATH python -m visualize.head_diversity --ood_dataset cifar10 --run_names $RUN_NAMES --reference_run_name $REFERENCE_RUN --display_names $DISPLAY_NAMES --use_wandb
