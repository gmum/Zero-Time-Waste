...
def main():
    ...
    common_args.dataset_args.variant = 'tv_convnext_t'
    ...
    base_model_args.model_class = 'tv_convnext_t'
    ...
    display_names.append(f'ConvNeXt-T')
    ...
    out_dir_name = f'ztw_convnext_t_{common_args.dataset}'
