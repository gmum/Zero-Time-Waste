...
def main():
    ...
    common_args.dataset_args.variant = 'tv_swin_v2_s'
    ...
    place_at = [i for i in range(1, 26)]
    ...
    base_model_args.model_class = 'tv_swin_v2_s'
    ...
    display_names.append(f'SwinV2-S')
    ...
    sdn_model_args.model_args.head_type = 'swin_standard_head'
    ...
    gpf_model_args.model_args.head_type = 'swin_standard_head'
    gpf_model_args.model_args.place_at = place_at
    gpf_model_args.model_args.head_dim = 128
    gpf_model_args.model_args.state_dropout = 0.0
    gpf_model_args.optimizer_class = 'adam'
    gpf_model_args.optimizer_args = {}
    gpf_model_args.optimizer_args.lr = 0.005
    ...
    l2w_model_args.model_args.head_type = 'swin_standard_head'
    l2w_model_args.model_args.place_at = place_at
    l2w_model_args.optimizer_class = 'sgd'
    l2w_model_args.optimizer_args = {}
    l2w_model_args.optimizer_args.lr = 0.005
    ...
    cascading_model_args.model_args.head_type = 'swin_cascading_head'
    ...
    cascading_model_args.optimizer_args.lr = 0.005
    ...
    out_dir_name = f'ztw_swin_v2_{common_args.dataset}'
